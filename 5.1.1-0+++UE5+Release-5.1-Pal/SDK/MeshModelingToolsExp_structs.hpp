...
public:
	...
	uint8                                        Pad_34CB[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_34D5[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_34E4[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_34ED[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Transform;                                         // 0x10(0x60)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKShapeElem                           Element;                                           // 0x70(0x30)(Edit, EditConst, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_3508[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
