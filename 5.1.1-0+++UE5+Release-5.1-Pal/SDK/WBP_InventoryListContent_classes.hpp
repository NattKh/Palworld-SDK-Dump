...
public:
	...
	void GetAllContents(TArray<class UWidget*>* Contents, TArray<class UWidget*>& CallFunc_GetAllChildren_ReturnValue);
	void AddWidget(class UWidget* InWidgett, class UWrapBoxSlot* CallFunc_AddChildToWrapBox_ReturnValue);
