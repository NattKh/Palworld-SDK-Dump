...
struct UWBP_PalElementIcon_C_SetElement_Params
{
public:
	...
	uint8                                        Pad_2693[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UTexture2D*                            CallFunc_Map_Find_Value_1;                         // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UTexture2D*                            K2Node_Select_Default;                             // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};

// 0x11 (0x11 - 0x0)
// Function WBP_PalElementIcon.WBP_PalElementIcon_C.ExecuteUbergraph_WBP_PalElementIcon
struct UWBP_PalElementIcon_C_ExecuteUbergraph_WBP_PalElementIcon_Params
{
public:
