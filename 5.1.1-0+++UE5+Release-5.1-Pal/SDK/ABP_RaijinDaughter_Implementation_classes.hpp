...
class UABP_RaijinDaughter_Implementation_C : public UPalAnimInstance
{
public:
	...
	static class UABP_RaijinDaughter_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_RaijinDaughter_Implementation(int32 EntryPoint);
};
