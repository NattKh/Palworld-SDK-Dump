...
public:
	...
	uint8                                        Pad_86C[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10E3[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1117[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1129[0xB8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1131[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1238[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12B0[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
