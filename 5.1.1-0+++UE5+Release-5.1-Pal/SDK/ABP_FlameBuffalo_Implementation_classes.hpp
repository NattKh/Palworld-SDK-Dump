...
class UABP_FlameBuffalo_Implementation_C : public UPalAnimInstance
{
public:
	...
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_2;                            // 0x800(0x250)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0xA50(0x20)(None)
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt_1;                            // 0xA70(0x250)(None)
	struct FAnimNode_LookAt                      AnimGraphNode_LookAt;                              // 0xCC0(0x250)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0xF10(0x20)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root_1;                              // 0xF30(0x20)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose_1;                   // 0xF50(0xC8)(None)
	struct FAnimNode_LinkedInputPose             AnimGraphNode_LinkedInputPose;                     // 0x1018(0xC8)(None)
	...
	static class UABP_FlameBuffalo_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_FlameBuffalo_Implementation(int32 EntryPoint);
};
