...
{
public:
	uint8                                        Pad_18A4[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_18A6[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
