...
public:
	...
	uint8                                        Pad_1827[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1829[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_184C[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_185D[0x9];                                     // Fixing Size After Last Property  [ Dumper-7 ]
