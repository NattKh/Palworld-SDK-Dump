...
class ABP_BuildObject_Stone_Stair_C : public APalBuildObject
{
public:
	class UStaticMeshComponent*                  SM_Stair_Stone;                                    // 0x570(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
