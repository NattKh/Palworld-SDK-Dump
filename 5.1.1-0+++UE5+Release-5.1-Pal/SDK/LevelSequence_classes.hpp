...
{
public:
	uint8                                        Pad_F48[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FFA[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1125[0x100];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1191[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
