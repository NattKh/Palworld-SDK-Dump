...
public:
	...
	uint8                                        Pad_AF3[0x76];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B10[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B4A[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B95[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
