...
class UABP_Penguin_Implementation_C : public UAnimInstance
{
public:
	...
	static class UABP_Penguin_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_Penguin_Implementation(int32 EntryPoint);
};
