...
public:
	...
	uint8                                        Pad_815[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_821[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_822[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_827[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_82B[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_82D[0x1C8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_832[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_838[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_844[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_861[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_890[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_892[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_894[0x57];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_898[0x74];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_89B[0x2C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_89D[0x124];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8A6[0x48];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8A7[0x98];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8B8[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8E8[0x198];                                    // Fixing Size Of Struct [ Dumper-7 ]
