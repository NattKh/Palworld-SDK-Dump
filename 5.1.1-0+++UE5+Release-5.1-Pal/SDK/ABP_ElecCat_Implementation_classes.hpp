...
class UABP_ElecCat_Implementation_C : public UAnimInstance
{
public:
	...
	uint8                                        Pad_32EC[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UABP_ElecCat_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_ElecCat_Implementation(int32 EntryPoint);
};
