...
class UABP_HawkBird_Implementation_C : public UPalAnimInstance
{
public:
	...
	uint8                                        Pad_6F8[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UABP_HawkBird_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_HawkBird_Implementation(int32 EntryPoint);
};
