...
public:
	...
	uint8                                        Pad_4F7[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5A3[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_5E5[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FEdgeID                               EdgeID;                                            // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5F7[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVertexInstanceID                     VertexInstanceID;                                  // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_657[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	struct FVertexID                             VertexID;                                          // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_693[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_909[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
