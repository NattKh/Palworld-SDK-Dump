...
class ABP_PalMonsterInframeRendererSoundPlayer_C : public AActor
{
public:
	class UPalSoundPlayerComponent*              PalSoundPlayer;                                    // 0x290(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
