...
class UABP_Eagle_Implementation_C : public UAnimInstance
{
public:
	...
	static class UABP_Eagle_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_Eagle_Implementation(int32 EntryPoint);
};
