...
class UClass* ABP_BuildObject_BuildableGoddessStatue_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildObject_BuildableGoddessStatue_C");

	return Clss;
}


// BP_BuildObject_BuildableGoddessStatue_C BP_BuildObject_BuildableGoddessStatue.Default__BP_BuildObject_BuildableGoddessStatue_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_BuildObject_BuildableGoddessStatue_C* ABP_BuildObject_BuildableGoddessStatue_C::GetDefaultObj()
{
	static class ABP_BuildObject_BuildableGoddessStatue_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_BuildObject_BuildableGoddessStatue_C*>(ABP_BuildObject_BuildableGoddessStatue_C::StaticClass()->DefaultObject);
...
void ABP_BuildObject_BuildableGoddessStatue_C::SetActive_Internal(bool bOn)
{
	...
	Params::ABP_BuildObject_BuildableGoddessStatue_C_SetActive_Internal_Params Parms{};
...
void ABP_BuildObject_BuildableGoddessStatue_C::BP_OnSetConcreteModel(class UPalMapObjectConcreteModelBase* ConcreteModel)
{
	...
	Params::ABP_BuildObject_BuildableGoddessStatue_C_BP_OnSetConcreteModel_Params Parms{};
...
void ABP_BuildObject_BuildableGoddessStatue_C::CustomEvent(class UPalMapObjectConcreteModelBase* Model)
{
	...
	Params::ABP_BuildObject_BuildableGoddessStatue_C_CustomEvent_Params Parms{};
...
void ABP_BuildObject_BuildableGoddessStatue_C::ExecuteUbergraph_BP_BuildObject_BuildableGoddessStatue(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UPalMapObjectConcreteModelBase* K2Node_Event_ConcreteModel, class UPalMapObjectConcreteModelBase* K2Node_CustomEvent_Model)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_BuildObject_BuildableGoddessStatue_C_ExecuteUbergraph_BP_BuildObject_BuildableGoddessStatue_Params Parms{};
