...
class UABP_Monkey_Implementation_C : public UPalAnimInstance
{
public:
	...
	static class UABP_Monkey_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_Monkey_Implementation(int32 EntryPoint);
};
