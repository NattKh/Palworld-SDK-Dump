...
struct UWBP_Ingame_TimeZone_C_ExecuteUbergraph_WBP_Ingame_TimeZone_Params
{
public:
	...
	class UPalTimeManager*                       CallFunc_GetTimeManager_ReturnValue_1;             // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class EPalOneDayTimeType                CallFunc_GetCurrentDayTimeType_ReturnValue;        // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetDayTimePassRate_ReturnValue;           // 0x44(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
