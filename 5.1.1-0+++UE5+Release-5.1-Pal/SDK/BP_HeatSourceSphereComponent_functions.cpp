...
class UClass* UBP_HeatSourceSphereComponent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_HeatSourceSphereComponent_C");

	return Clss;
}


// BP_HeatSourceSphereComponent_C BP_HeatSourceSphereComponent.Default__BP_HeatSourceSphereComponent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_HeatSourceSphereComponent_C* UBP_HeatSourceSphereComponent_C::GetDefaultObj()
{
	static class UBP_HeatSourceSphereComponent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_HeatSourceSphereComponent_C*>(UBP_HeatSourceSphereComponent_C::StaticClass()->DefaultObject);
...
void UBP_HeatSourceSphereComponent_C::Begin(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_HeatSourceSphereComponent_C_Begin_Params Parms{};
...
void UBP_HeatSourceSphereComponent_C::End(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	...
	Params::UBP_HeatSourceSphereComponent_C_End_Params Parms{};
...
void UBP_HeatSourceSphereComponent_C::ExecuteUbergraph_BP_HeatSourceSphereComponent(int32 EntryPoint, bool CallFunc_IsServer_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UPrimitiveComponent* K2Node_CustomEvent_OverlappedComponent_1, class AActor* K2Node_CustomEvent_OtherActor_1, class UPrimitiveComponent* K2Node_CustomEvent_OtherComp_1, int32 K2Node_CustomEvent_OtherBodyIndex_1, bool K2Node_CustomEvent_bFromSweep, const struct FHitResult& K2Node_CustomEvent_SweepResult, class UPrimitiveComponent* K2Node_CustomEvent_OverlappedComponent, class AActor* K2Node_CustomEvent_OtherActor, class UPrimitiveComponent* K2Node_CustomEvent_OtherComp, int32 K2Node_CustomEvent_OtherBodyIndex, class AActor* CallFunc_GetOwner_ReturnValue, const class FString& CallFunc_GetObjectName_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue, const struct FPalHeatSourceInfo& K2Node_MakeStruct_PalHeatSourceInfo, class UPalHeatSourceModule* CallFunc_GetModule_ReturnValue, class UPalHeatSourceModule* CallFunc_GetModule_ReturnValue_1, class UPalHeatSourceModule* CallFunc_GetModule_ReturnValue_2)
{
	...
	Params::UBP_HeatSourceSphereComponent_C_ExecuteUbergraph_BP_HeatSourceSphereComponent_Params Parms{};
