...
{
public:
	class UPalWorkFacingComponent*               WorkFacing;                                        // 0x570(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class UPalMapObjectItemConverterParameterComponent* ItemConverterParameter;                            // 0x580(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
