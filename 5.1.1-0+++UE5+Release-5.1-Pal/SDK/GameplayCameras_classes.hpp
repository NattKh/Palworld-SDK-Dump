...
public:
	...
	uint8                                        Pad_EEC[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EED[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F79[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FB0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FB6[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_105C[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_107D[0x3C];                                    // Fixing Size Of Struct [ Dumper-7 ]
