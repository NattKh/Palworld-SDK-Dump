...
class UClass* ABP_BuildObject_SphereFactory_Black_02_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildObject_SphereFactory_Black_02_C");

	return Clss;
}


// BP_BuildObject_SphereFactory_Black_02_C BP_BuildObject_SphereFactory_Black_02.Default__BP_BuildObject_SphereFactory_Black_02_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_BuildObject_SphereFactory_Black_02_C* ABP_BuildObject_SphereFactory_Black_02_C::GetDefaultObj()
{
	static class ABP_BuildObject_SphereFactory_Black_02_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_BuildObject_SphereFactory_Black_02_C*>(ABP_BuildObject_SphereFactory_Black_02_C::StaticClass()->DefaultObject);
...
void ABP_BuildObject_SphereFactory_Black_02_C::OnSetConcreteModel(class UPalMapObjectConcreteModelBase* Model)
{
	...
	Params::ABP_BuildObject_SphereFactory_Black_02_C_OnSetConcreteModel_Params Parms{};
...
void ABP_BuildObject_SphereFactory_Black_02_C::ExecuteUbergraph_BP_BuildObject_SphereFactory_Black_02(int32 EntryPoint, class UPalMapObjectConcreteModelBase* K2Node_CustomEvent_Model, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	...
	Params::ABP_BuildObject_SphereFactory_Black_02_C_ExecuteUbergraph_BP_BuildObject_SphereFactory_Black_02_Params Parms{};
