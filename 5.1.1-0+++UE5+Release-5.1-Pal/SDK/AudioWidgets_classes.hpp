...
public:
	...
	uint8                                        Pad_15DB[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1C8A[0x178];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_24F5[0x768];                                   // Fixing Size Of Struct [ Dumper-7 ]
