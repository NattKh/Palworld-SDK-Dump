...
class ABP_BuildObject_Factory_Hard_01_C : public APalBuildObject
{
public:
	class UStaticMeshComponent*                  StaticMesh;                                        // 0x570(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
