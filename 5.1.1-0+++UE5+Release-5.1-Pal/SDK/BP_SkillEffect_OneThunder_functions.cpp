...
class UClass* ABP_SkillEffect_OneThunder_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_SkillEffect_OneThunder_C");

	return Clss;
}


// BP_SkillEffect_OneThunder_C BP_SkillEffect_OneThunder.Default__BP_SkillEffect_OneThunder_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_SkillEffect_OneThunder_C* ABP_SkillEffect_OneThunder_C::GetDefaultObj()
{
	static class ABP_SkillEffect_OneThunder_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_SkillEffect_OneThunder_C*>(ABP_SkillEffect_OneThunder_C::StaticClass()->DefaultObject);
...
void ABP_SkillEffect_OneThunder_C::SpawnBullet(int32 Count, const struct FVector& CallFunc_GetActionTargetLocation_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, const struct FVector& CallFunc_GetActorScale3D_ReturnValue, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AActor* CallFunc_FinishSpawningActor_ReturnValue, class AActor* CallFunc_AdjustActorToFloor_ReturnValue)
{
	...
	Params::ABP_SkillEffect_OneThunder_C_SpawnBullet_Params Parms{};
