...
class UABP_RobinHood_Implementation_C : public UPalAnimInstance
{
public:
	...
	static class UABP_RobinHood_Implementation_C* GetDefaultObj();
	...
	void ExecuteUbergraph_ABP_RobinHood_Implementation(int32 EntryPoint);
};
