...
{
public:
	uint8                                        Pad_68A[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_690[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_696[0x25];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7A7[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_28 : 1;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_7C6[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B20[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
