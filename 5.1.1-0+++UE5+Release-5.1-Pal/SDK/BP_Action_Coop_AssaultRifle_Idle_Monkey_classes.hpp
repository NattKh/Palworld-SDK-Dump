...
class UBP_Action_Coop_AssaultRifle_Idle_Monkey_C : public UPalActionBase
{
public:
	...
	static class UBP_Action_Coop_AssaultRifle_Idle_Monkey_C* GetDefaultObj();
