...
{
public:
	uint8                                        Pad_7F0[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_843[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_856[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8D8[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
