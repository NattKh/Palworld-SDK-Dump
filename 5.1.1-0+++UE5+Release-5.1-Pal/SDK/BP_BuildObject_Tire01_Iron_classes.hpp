...
{
public:
	class UStaticMeshComponent*                  Cube;                                              // 0x570(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                  SM_tire1;                                          // 0x578(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_BuildObject_Tire01_Iron_C* GetDefaultObj();
