...
class UClass* ABP_BuildObject_Spa_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildObject_Spa_C");

	return Clss;
}


// BP_BuildObject_Spa_C BP_BuildObject_Spa.Default__BP_BuildObject_Spa_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_BuildObject_Spa_C* ABP_BuildObject_Spa_C::GetDefaultObj()
{
	static class ABP_BuildObject_Spa_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_BuildObject_Spa_C*>(ABP_BuildObject_Spa_C::StaticClass()->DefaultObject);
...
void ABP_BuildObject_Spa_C::SetActive_Internal(bool bOn)
{
	...
	Params::ABP_BuildObject_Spa_C_SetActive_Internal_Params Parms{};
...
void ABP_BuildObject_Spa_C::OnUpdateCharacter(class UPalMapObjectAmusementModel* Model, class APalCharacter* CallFunc_TryGetIndividualActor_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_BuildObject_Spa_C_OnUpdateCharacter_Params Parms{};
...
void ABP_BuildObject_Spa_C::OnStartUsingInServer(class UPalMapObjectAmusementModel* Model, class APalCharacter* Character, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, const struct FHitResult& CallFunc_K2_SetActorLocation_SweepHitResult, bool CallFunc_K2_SetActorLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_BuildObject_Spa_C_OnStartUsingInServer_Params Parms{};
...
void ABP_BuildObject_Spa_C::CustomEvent(class UPalMapObjectConcreteModelBase* Model)
{
	...
	Params::ABP_BuildObject_Spa_C_CustomEvent_Params Parms{};
...
void ABP_BuildObject_Spa_C::BP_OnSetConcreteModel(class UPalMapObjectConcreteModelBase* ConcreteModel)
{
	...
	Params::ABP_BuildObject_Spa_C_BP_OnSetConcreteModel_Params Parms{};
...
void ABP_BuildObject_Spa_C::ExecuteUbergraph_BP_BuildObject_Spa(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UPalMapObjectConcreteModelBase* K2Node_CustomEvent_Model, class UPalMapObjectConcreteModelBase* K2Node_Event_ConcreteModel, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UPalMapObjectAmusementModel* K2Node_DynamicCast_AsPal_Map_Object_Amusement_Model, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_BuildObject_Spa_C_ExecuteUbergraph_BP_BuildObject_Spa_Params Parms{};
