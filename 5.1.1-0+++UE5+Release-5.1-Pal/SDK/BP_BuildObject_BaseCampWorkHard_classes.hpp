...
class ABP_BuildObject_BaseCampWorkHard_C : public APalBuildObject
{
public:
	class UPalMapObjectBaseCampPassiveEffectWorkHardParameterComponent* BaseCampPassiveEffectWorkHardParameter;            // 0x570(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
